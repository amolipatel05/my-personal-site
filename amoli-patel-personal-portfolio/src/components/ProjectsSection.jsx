  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-6 mx-auto justify-items-center bg-background py-8 dark:bg-background-dark mdlg:grid-cols-2 xl:grid-cols-3 w-fit">
        <div className="shadow-2xl bg-gray-200 h-140 w-80 rounded-lg dark:bg-gray-300">
          ...
          <div className="p-4">
            ...
            ></img>
            <div className="bg-gray-200 rounded-xl p-2 align">
        ...
        <div className="bg-gray-200 h-96 w-60 rounded-lg dark:bg-gray-300"></div>
        <div className="bg-gray-200 h-96 w-60 rounded-lg dark:bg-gray-300"></div>
        <div className="bg-gray-200 h-96 w-60 rounded-lg dark:bg-gray-300"></div>
        <div className="bg-gray-200 h-96 w-60 rounded-lg dark:bg-gray-300"></div>
      </div>
